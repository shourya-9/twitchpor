...
var Play_live_token =
    '{"query":"{streamPlaybackAccessToken(channelName:\\"%x\\", params:{platform:\\"web\\",playerType:\\"site\\"}){value signature}}"}';
var Play_vod_token = '{"query":"{videoPlaybackAccessToken(id:\\"%x\\", params:{platform:\\"web\\",playerType:\\"site\\"}){value signature}}"}';
